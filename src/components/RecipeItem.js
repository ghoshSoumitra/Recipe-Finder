      ...
      {(loading && (
        ...
        <div className='recipe-item-section container mx-auto px-5 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:px-0'>
          ...
          <div className='recipe-details-sec flex flex-col gap-5 row-start-1 lg:row-auto'>
            <span className='publisher text-white font-semibold uppercase tracking-widest'>
              {recipe?.publisher}
            </span>
            <h2 className='title capitalize text-4xl lg:text-6xl' style={{textShadow:'2px 2px white'}}>
              {recipe?.title}
            </h2>
            <div className='servings-cooking-time flex flex-col justify-between gap-5 lg:flex-row font-semibold tracking-widest text-white uppercase'>
          ...
          <div className='recipe-ingredients-sec col-span-full'>
            <span className='ing-title text-2xl text-white lg:text-4xl font-medium mb-5 flex items-center gap-3'>
